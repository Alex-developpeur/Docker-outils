...
```
cd existing_repo
git remote add origin https://gitlab-gr3.cefim-formation.org/devops/Outils.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab-gr3.cefim-formation.org/devops/Outils/-/settings/integrations)
